...
// function verifyToken(token, callback, data) {
...
//         token,
//         clientId,
//         callback(e, login, data)
//     );
//     return userId;
// }

// function getIdFromToken(login) {
//     var payload = login.getPayload();
//     userId = payload['sub'];
//     return userId;
// }

// function addSession(e, login, routes) {
//     if (e) {
//         sendError(e, res);
//     }

//     var userId = getIdFromToken(login);
//     connection((db) => {
...
//     verifyToken(req.body.token, addSession, req.body.routes);
// });
